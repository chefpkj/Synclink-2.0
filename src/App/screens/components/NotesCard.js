...
const EditButton=({linkId})=>{
    return (
        <Link to={"/viewLink/"+linkId} className="bg-[#2F353D] w-10 h-5 rounded-3xl ml-auto mr-5 pb-2 flex flex-row  justify-center items-center hover:cursor-pointer hover:bg-[#3C434E] "><button><h1>...</h1></button></Link>
    );
}
